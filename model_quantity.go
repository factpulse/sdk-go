...
func (dst *Quantity) UnmarshalJSON(data []byte) error {
	var err error
	...
	return fmt.Errorf("data failed to match schemas in anyOf(Quantity)")
}

// Marshal data from the first non-nil pointers in the struct to JSON
func (src Quantity) MarshalJSON() ([]byte, error) {
	if src.Float32 != nil {
