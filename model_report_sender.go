...
// checks if the ReportSender type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ReportSender{}

// ReportSender Report sender information (PA transmitting the report).  In PPF architecture, the sender is typically the PA (Plateforme Agréée) transmitting on behalf of the declarant (issuer).
type ReportSender struct {
	// SIREN or SIRET number of the sender (PA or company)
...
type _ReportSender ReportSender
...
func (o *ReportSender) SetVatIdNil() {
	o.VatId.Set(nil)
}
...
func (o ReportSender) MarshalJSON() ([]byte, error) {
...
func (o ReportSender) ToMap() (map[string]interface{}, error) {
...
func (o *ReportSender) UnmarshalJSON(data []byte) (err error) {
	...
	varReportSender := _ReportSender{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varReportSender)

	if err != nil {
		return err
	}

	*o = ReportSender(varReportSender)

	return err
}

type NullableReportSender struct {
	value *ReportSender
	isSet bool
}

func (v NullableReportSender) Get() *ReportSender {
	return v.value
}

func (v *NullableReportSender) Set(val *ReportSender) {
	v.value = val
	v.isSet = true
}

func (v NullableReportSender) IsSet() bool {
	return v.isSet
}

func (v *NullableReportSender) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableReportSender(val *ReportSender) *NullableReportSender {
	return &NullableReportSender{value: val, isSet: true}
}

func (v NullableReportSender) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableReportSender) UnmarshalJSON(src []byte) error {
	v.isSet = true
