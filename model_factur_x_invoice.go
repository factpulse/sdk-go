...
// GetSubmissionMode returns the SubmissionMode field value if set, zero value otherwise.
func (o *FacturXInvoice) GetSubmissionMode() SubmissionMode {
	if o == nil || IsNil(o.SubmissionMode) {
...
// GetSubmissionModeOk returns a tuple with the SubmissionMode field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// SetSubmissionMode gets a reference to the given SubmissionMode and assigns it to the SubmissionMode field.
