...
// checks if the GenerateEReportingResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GenerateEReportingResponse{}

// GenerateEReportingResponse Response after generating e-reporting XML.
type GenerateEReportingResponse struct {
	// Report identifier
...
type _GenerateEReportingResponse GenerateEReportingResponse
...
func NewGenerateEReportingResponse(reportId string, flowType string, xml string, xmlSize int32, message string) *GenerateEReportingResponse {
	this := GenerateEReportingResponse{}
...
func (o GenerateEReportingResponse) MarshalJSON() ([]byte, error) {
...
func (o GenerateEReportingResponse) ToMap() (map[string]interface{}, error) {
...
func (o *GenerateEReportingResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varGenerateEReportingResponse := _GenerateEReportingResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGenerateEReportingResponse)

	if err != nil {
		return err
	}

	*o = GenerateEReportingResponse(varGenerateEReportingResponse)

	return err
}

type NullableGenerateEReportingResponse struct {
	value *GenerateEReportingResponse
	isSet bool
}

func (v NullableGenerateEReportingResponse) Get() *GenerateEReportingResponse {
	return v.value
}

func (v *NullableGenerateEReportingResponse) Set(val *GenerateEReportingResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableGenerateEReportingResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableGenerateEReportingResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGenerateEReportingResponse(val *GenerateEReportingResponse) *NullableGenerateEReportingResponse {
	return &NullableGenerateEReportingResponse{value: val, isSet: true}
}

func (v NullableGenerateEReportingResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGenerateEReportingResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
