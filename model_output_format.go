...
// OutputFormat Output format for invoice generation.  - ``xml``: CII XML (Cross-Industry Invoice, Factur-X syntax) — backward-compatible alias - ``cii``: CII XML — explicit alias, same as ``xml`` - ``ubl``: UBL 2.1 XML (OASIS Universal Business Language) - ``pdf``: Factur-X PDF/A-3 with embedded CII XML
type OutputFormat string

// List of OutputFormat
const (
	OUTPUTFORMAT_XML OutputFormat = "xml"
	OUTPUTFORMAT_CII OutputFormat = "cii"
	OUTPUTFORMAT_UBL OutputFormat = "ubl"
