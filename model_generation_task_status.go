...
// checks if the GenerationTaskStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GenerationTaskStatus{}

// GenerationTaskStatus Typed task status for invoice generation.
type GenerationTaskStatus struct {
	TaskId string `json:"taskId"`
	Status CeleryStatus `json:"status"`
	Result NullableGenerationTaskStatusResult `json:"result,omitempty"`
}

type _GenerationTaskStatus GenerationTaskStatus
...
func (o *GenerationTaskStatus) GetResult() GenerationTaskStatusResult {
	if o == nil || IsNil(o.Result.Get()) {
		var ret GenerationTaskStatusResult
		return ret
	}
	return *o.Result.Get()
}
...
// SetResult gets a reference to the given NullableGenerationTaskStatusResult and assigns it to the Result field.
func (o *GenerationTaskStatus) SetResult(v GenerationTaskStatusResult) {
	o.Result.Set(&v)
}
// SetResultNil sets the value for Result to be an explicit nil
func (o *GenerationTaskStatus) SetResultNil() {
	o.Result.Set(nil)
}
...
func (o GenerationTaskStatus) MarshalJSON() ([]byte, error) {
...
func (o GenerationTaskStatus) ToMap() (map[string]interface{}, error) {
...
func (o *GenerationTaskStatus) UnmarshalJSON(data []byte) (err error) {
	...
	varGenerationTaskStatus := _GenerationTaskStatus{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGenerationTaskStatus)

	if err != nil {
		return err
	}

	*o = GenerationTaskStatus(varGenerationTaskStatus)

	return err
}

type NullableGenerationTaskStatus struct {
	value *GenerationTaskStatus
	isSet bool
}

func (v NullableGenerationTaskStatus) Get() *GenerationTaskStatus {
	return v.value
}

func (v *NullableGenerationTaskStatus) Set(val *GenerationTaskStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableGenerationTaskStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableGenerationTaskStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGenerationTaskStatus(val *GenerationTaskStatus) *NullableGenerationTaskStatus {
	return &NullableGenerationTaskStatus{value: val, isSet: true}
}

func (v NullableGenerationTaskStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGenerationTaskStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
