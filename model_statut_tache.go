...
func (o StatutTache) ToMap() (map[string]interface{}, error) {
...
func (o *StatutTache) UnmarshalJSON(data []byte) (err error) {
	...
	varStatutTache := _StatutTache{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varStatutTache)

	if err != nil {
		return err
	}

	*o = StatutTache(varStatutTache)

	return err
}

type NullableStatutTache struct {
	value *StatutTache
	isSet bool
}

func (v NullableStatutTache) Get() *StatutTache {
	return v.value
}

func (v *NullableStatutTache) Set(val *StatutTache) {
	v.value = val
	v.isSet = true
}

func (v NullableStatutTache) IsSet() bool {
	return v.isSet
}

func (v *NullableStatutTache) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableStatutTache(val *StatutTache) *NullableStatutTache {
	return &NullableStatutTache{value: val, isSet: true}
}

func (v NullableStatutTache) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableStatutTache) UnmarshalJSON(src []byte) error {
	v.isSet = true
