...
// checks if the AFNORSearchDirectoryLine type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AFNORSearchDirectoryLine{}

// AFNORSearchDirectoryLine struct for AFNORSearchDirectoryLine
type AFNORSearchDirectoryLine struct {
	Filters *AFNORSearchDirectoryLineFilters `json:"filters,omitempty"`
	// Sorting criteria on a field and an order (ascending or descending).
	Sorting []AFNORSearchDirectoryLineSortingInner `json:"sorting,omitempty"`
	// Allows you to filter the desired fields in the response.
	Fields []AFNORDirectoryLineField `json:"fields,omitempty"`
...
func (o *AFNORSearchDirectoryLine) GetFilters() AFNORSearchDirectoryLineFilters {
	if o == nil || IsNil(o.Filters) {
		var ret AFNORSearchDirectoryLineFilters
		return ret
	}
	return *o.Filters
}
...
// SetFilters gets a reference to the given AFNORSearchDirectoryLineFilters and assigns it to the Filters field.
...
func (o *AFNORSearchDirectoryLine) GetSorting() []AFNORSearchDirectoryLineSortingInner {
	if o == nil || IsNil(o.Sorting) {
		var ret []AFNORSearchDirectoryLineSortingInner
		return ret
	}
	return o.Sorting
}
...
// SetSorting gets a reference to the given []AFNORSearchDirectoryLineSortingInner and assigns it to the Sorting field.
...
// SetFields gets a reference to the given []AFNORDirectoryLineField and assigns it to the Fields field.
...
func (o AFNORSearchDirectoryLine) MarshalJSON() ([]byte, error) {
...
func (o AFNORSearchDirectoryLine) ToMap() (map[string]interface{}, error) {
...
type NullableAFNORSearchDirectoryLine struct {
	value *AFNORSearchDirectoryLine
	isSet bool
}

func (v NullableAFNORSearchDirectoryLine) Get() *AFNORSearchDirectoryLine {
	return v.value
}

func (v *NullableAFNORSearchDirectoryLine) Set(val *AFNORSearchDirectoryLine) {
	v.value = val
	v.isSet = true
}

func (v NullableAFNORSearchDirectoryLine) IsSet() bool {
	return v.isSet
}

func (v *NullableAFNORSearchDirectoryLine) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAFNORSearchDirectoryLine(val *AFNORSearchDirectoryLine) *NullableAFNORSearchDirectoryLine {
	return &NullableAFNORSearchDirectoryLine{value: val, isSet: true}
}

func (v NullableAFNORSearchDirectoryLine) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAFNORSearchDirectoryLine) UnmarshalJSON(src []byte) error {
	v.isSet = true
