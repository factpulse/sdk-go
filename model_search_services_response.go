...
// checks if the SearchServicesResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SearchServicesResponse{}

// SearchServicesResponse Structure services list.
...
type _SearchServicesResponse SearchServicesResponse
...
// SetServices gets a reference to the given []StructureService and assigns it to the Services field.
...
func (o SearchServicesResponse) MarshalJSON() ([]byte, error) {
...
func (o SearchServicesResponse) ToMap() (map[string]interface{}, error) {
...
func (o *SearchServicesResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varSearchServicesResponse := _SearchServicesResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varSearchServicesResponse)

	if err != nil {
		return err
	}

	*o = SearchServicesResponse(varSearchServicesResponse)

	return err
}

type NullableSearchServicesResponse struct {
	value *SearchServicesResponse
	isSet bool
}

func (v NullableSearchServicesResponse) Get() *SearchServicesResponse {
	return v.value
}

func (v *NullableSearchServicesResponse) Set(val *SearchServicesResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableSearchServicesResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableSearchServicesResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSearchServicesResponse(val *SearchServicesResponse) *NullableSearchServicesResponse {
	return &NullableSearchServicesResponse{value: val, isSet: true}
}

func (v NullableSearchServicesResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSearchServicesResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
