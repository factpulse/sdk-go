...
// checks if the AFNORWebhook type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AFNORWebhook{}

// AFNORWebhook struct for AFNORWebhook
type AFNORWebhook struct {
	WebhookId *string `json:"webhookId,omitempty"`
	Callback AFNORCallbackParameters `json:"callback"`
	Metadata AFNORWebhookMetadata `json:"metadata"`
}

type _AFNORWebhook AFNORWebhook
...
func (o AFNORWebhook) MarshalJSON() ([]byte, error) {
...
func (o AFNORWebhook) ToMap() (map[string]interface{}, error) {
...
func (o *AFNORWebhook) UnmarshalJSON(data []byte) (err error) {
	...
	varAFNORWebhook := _AFNORWebhook{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAFNORWebhook)

	if err != nil {
		return err
	}

	*o = AFNORWebhook(varAFNORWebhook)

	return err
}

type NullableAFNORWebhook struct {
	value *AFNORWebhook
	isSet bool
}

func (v NullableAFNORWebhook) Get() *AFNORWebhook {
	return v.value
}

func (v *NullableAFNORWebhook) Set(val *AFNORWebhook) {
	v.value = val
	v.isSet = true
}

func (v NullableAFNORWebhook) IsSet() bool {
	return v.isSet
}

func (v *NullableAFNORWebhook) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAFNORWebhook(val *AFNORWebhook) *NullableAFNORWebhook {
	return &NullableAFNORWebhook{value: val, isSet: true}
}

func (v NullableAFNORWebhook) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAFNORWebhook) UnmarshalJSON(src []byte) error {
	v.isSet = true
