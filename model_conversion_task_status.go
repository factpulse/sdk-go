...
// checks if the ConversionTaskStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ConversionTaskStatus{}

// ConversionTaskStatus Typed task status for document conversion.
type ConversionTaskStatus struct {
	TaskId string `json:"taskId"`
	Status CeleryStatus `json:"status"`
	Result NullableConversionTaskStatusResult `json:"result,omitempty"`
}

type _ConversionTaskStatus ConversionTaskStatus
...
func (o *ConversionTaskStatus) GetResult() ConversionTaskStatusResult {
	if o == nil || IsNil(o.Result.Get()) {
		var ret ConversionTaskStatusResult
		return ret
	}
	return *o.Result.Get()
}
...
// SetResult gets a reference to the given NullableConversionTaskStatusResult and assigns it to the Result field.
func (o *ConversionTaskStatus) SetResult(v ConversionTaskStatusResult) {
	o.Result.Set(&v)
}
// SetResultNil sets the value for Result to be an explicit nil
func (o *ConversionTaskStatus) SetResultNil() {
	o.Result.Set(nil)
}
...
func (o ConversionTaskStatus) MarshalJSON() ([]byte, error) {
...
func (o ConversionTaskStatus) ToMap() (map[string]interface{}, error) {
...
func (o *ConversionTaskStatus) UnmarshalJSON(data []byte) (err error) {
	...
	varConversionTaskStatus := _ConversionTaskStatus{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varConversionTaskStatus)

	if err != nil {
		return err
	}

	*o = ConversionTaskStatus(varConversionTaskStatus)

	return err
}

type NullableConversionTaskStatus struct {
	value *ConversionTaskStatus
	isSet bool
}

func (v NullableConversionTaskStatus) Get() *ConversionTaskStatus {
	return v.value
}

func (v *NullableConversionTaskStatus) Set(val *ConversionTaskStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableConversionTaskStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableConversionTaskStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableConversionTaskStatus(val *ConversionTaskStatus) *NullableConversionTaskStatus {
	return &NullableConversionTaskStatus{value: val, isSet: true}
}

func (v NullableConversionTaskStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableConversionTaskStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
