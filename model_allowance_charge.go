...
type AllowanceCharge struct {
	...
	VatCategory NullableString `json:"vat_category,omitempty"`
...
// SetVatCategory gets a reference to the given NullableString and assigns it to the VatCategory field.
