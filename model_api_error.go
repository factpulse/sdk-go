...
// APIError Standardized API error (aligned with AFNOR Error schema).  Unified format for all HTTP error responses.
type APIError struct {
	// Alphanumeric code precisely identifying the error
	ErrorCode string `json:"errorCode"`
	// Message describing the error (not intended for end user)
