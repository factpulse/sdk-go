...
// checks if the AFNORHealthCheckResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AFNORHealthCheckResponse{}

// AFNORHealthCheckResponse Response from AFNOR services healthcheck.
type AFNORHealthCheckResponse struct {
	// Flow Service API status
	FlowServiceOk bool `json:"flow_service_ok"`
	// Directory Service API status
	DirectoryServiceOk bool `json:"directory_service_ok"`
	// Descriptive status message
	Message string `json:"message"`
}

type _AFNORHealthCheckResponse AFNORHealthCheckResponse
...
func (o AFNORHealthCheckResponse) MarshalJSON() ([]byte, error) {
...
func (o AFNORHealthCheckResponse) ToMap() (map[string]interface{}, error) {
...
func (o *AFNORHealthCheckResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varAFNORHealthCheckResponse := _AFNORHealthCheckResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAFNORHealthCheckResponse)

	if err != nil {
		return err
	}

	*o = AFNORHealthCheckResponse(varAFNORHealthCheckResponse)

	return err
}

type NullableAFNORHealthCheckResponse struct {
	value *AFNORHealthCheckResponse
	isSet bool
}

func (v NullableAFNORHealthCheckResponse) Get() *AFNORHealthCheckResponse {
	return v.value
}

func (v *NullableAFNORHealthCheckResponse) Set(val *AFNORHealthCheckResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableAFNORHealthCheckResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableAFNORHealthCheckResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAFNORHealthCheckResponse(val *AFNORHealthCheckResponse) *NullableAFNORHealthCheckResponse {
	return &NullableAFNORHealthCheckResponse{value: val, isSet: true}
}

func (v NullableAFNORHealthCheckResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAFNORHealthCheckResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
