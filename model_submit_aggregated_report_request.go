...
// checks if the SubmitAggregatedReportRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SubmitAggregatedReportRequest{}

// SubmitAggregatedReportRequest Request to submit an aggregated e-reporting to a PA/PDP.
type SubmitAggregatedReportRequest struct {
	// Aggregated e-reporting data
	Data CreateAggregatedReportRequest `json:"data"`
...
type _SubmitAggregatedReportRequest SubmitAggregatedReportRequest
...
func NewSubmitAggregatedReportRequest(data CreateAggregatedReportRequest) *SubmitAggregatedReportRequest {
	this := SubmitAggregatedReportRequest{}
	this.Data = data
	return &this
}
...
func (o *SubmitAggregatedReportRequest) GetData() CreateAggregatedReportRequest {
	if o == nil {
		var ret CreateAggregatedReportRequest
		return ret
	}
...
func (o *SubmitAggregatedReportRequest) SetTrackingIdNil() {
...
func (o *SubmitAggregatedReportRequest) SetPdpFlowServiceUrlNil() {
...
func (o *SubmitAggregatedReportRequest) SetPdpTokenUrlNil() {
...
func (o *SubmitAggregatedReportRequest) SetPdpClientIdNil() {
...
func (o *SubmitAggregatedReportRequest) SetPdpClientSecretNil() {
...
func (o SubmitAggregatedReportRequest) MarshalJSON() ([]byte, error) {
...
func (o SubmitAggregatedReportRequest) ToMap() (map[string]interface{}, error) {
...
func (o *SubmitAggregatedReportRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varSubmitAggregatedReportRequest := _SubmitAggregatedReportRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varSubmitAggregatedReportRequest)

	if err != nil {
		return err
	}

	*o = SubmitAggregatedReportRequest(varSubmitAggregatedReportRequest)

	return err
}

type NullableSubmitAggregatedReportRequest struct {
	value *SubmitAggregatedReportRequest
	isSet bool
}

func (v NullableSubmitAggregatedReportRequest) Get() *SubmitAggregatedReportRequest {
	return v.value
}

func (v *NullableSubmitAggregatedReportRequest) Set(val *SubmitAggregatedReportRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableSubmitAggregatedReportRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableSubmitAggregatedReportRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSubmitAggregatedReportRequest(val *SubmitAggregatedReportRequest) *NullableSubmitAggregatedReportRequest {
	return &NullableSubmitAggregatedReportRequest{value: val, isSet: true}
}

func (v NullableSubmitAggregatedReportRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSubmitAggregatedReportRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
