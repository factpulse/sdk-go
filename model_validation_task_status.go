...
// checks if the ValidationTaskStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ValidationTaskStatus{}

// ValidationTaskStatus Typed task status for Factur-X validation.
type ValidationTaskStatus struct {
	TaskId string `json:"taskId"`
	Status CeleryStatus `json:"status"`
	Result NullableValidationTaskStatusResult `json:"result,omitempty"`
}

type _ValidationTaskStatus ValidationTaskStatus
...
func (o *ValidationTaskStatus) GetResult() ValidationTaskStatusResult {
	if o == nil || IsNil(o.Result.Get()) {
		var ret ValidationTaskStatusResult
		return ret
	}
	return *o.Result.Get()
}
...
// SetResult gets a reference to the given NullableValidationTaskStatusResult and assigns it to the Result field.
func (o *ValidationTaskStatus) SetResult(v ValidationTaskStatusResult) {
	o.Result.Set(&v)
}
// SetResultNil sets the value for Result to be an explicit nil
func (o *ValidationTaskStatus) SetResultNil() {
	o.Result.Set(nil)
}
...
func (o ValidationTaskStatus) MarshalJSON() ([]byte, error) {
...
func (o ValidationTaskStatus) ToMap() (map[string]interface{}, error) {
...
func (o *ValidationTaskStatus) UnmarshalJSON(data []byte) (err error) {
	...
	varValidationTaskStatus := _ValidationTaskStatus{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varValidationTaskStatus)

	if err != nil {
		return err
	}

	*o = ValidationTaskStatus(varValidationTaskStatus)

	return err
}

type NullableValidationTaskStatus struct {
	value *ValidationTaskStatus
	isSet bool
}

func (v NullableValidationTaskStatus) Get() *ValidationTaskStatus {
	return v.value
}

func (v *NullableValidationTaskStatus) Set(val *ValidationTaskStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableValidationTaskStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableValidationTaskStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableValidationTaskStatus(val *ValidationTaskStatus) *NullableValidationTaskStatus {
	return &NullableValidationTaskStatus{value: val, isSet: true}
}

func (v NullableValidationTaskStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableValidationTaskStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
