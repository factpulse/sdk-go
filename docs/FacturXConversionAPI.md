...
> ConversionTaskStatus GetConversionTaskStatusApiV1ConvertTasksTaskIdConversionStatusGet(ctx, taskId).Execute()
...
func main() {
	taskId := "taskId_example" // string | Celery task ID returned by POST /convert

	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.FacturXConversionAPI.GetConversionTaskStatusApiV1ConvertTasksTaskIdConversionStatusGet(context.Background(), taskId).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `FacturXConversionAPI.GetConversionTaskStatusApiV1ConvertTasksTaskIdConversionStatusGet``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `GetConversionTaskStatusApiV1ConvertTasksTaskIdConversionStatusGet`: ConversionTaskStatus
	fmt.Fprintf(os.Stdout, "Response from `FacturXConversionAPI.GetConversionTaskStatusApiV1ConvertTasksTaskIdConversionStatusGet`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiGetConversionTaskStatusApiV1ConvertTasksTaskIdConversionStatusGetRequest struct via the builder pattern
