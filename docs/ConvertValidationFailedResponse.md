...
------------ | ------------- | ------------- | -------------
**Status** | Pointer to **string** | Statut de la conversion | [optional] [default to "validation_failed"]
**ConversionId** | **string** | Identifiant unique de conversion | 
**Message** | Pointer to **string** | Message explicatif | [optional] [default to "Donnees extraites avec erreurs de validation. Completez le formulaire et appelez /resume."]
