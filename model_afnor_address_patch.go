...
// checks if the AFNORAddressPatch type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AFNORAddressPatch{}

// AFNORAddressPatch Wrapper for postal addresses
type AFNORAddressPatch struct {
	// Corresponds to the address of the recipient structure having defined the directory line(s).
	LigneAdresse1 *string `json:"ligneAdresse1,omitempty" validate:"regexp=^(?!\\\\s*$).+"`
	// Corresponds to the address of the recipient structure having defined the directory line(s).
	...
	Locality *string `json:"locality,omitempty" validate:"regexp=^(?!\\\\s*$).+"`
	// Corresponds to the country code of the recipient structure
	CodePays *string `json:"codePays,omitempty" validate:"regexp=^(?!\\\\s*$).+"`
}
...
func (o AFNORAddressPatch) MarshalJSON() ([]byte, error) {
...
func (o AFNORAddressPatch) ToMap() (map[string]interface{}, error) {
...
type NullableAFNORAddressPatch struct {
	value *AFNORAddressPatch
	isSet bool
}

func (v NullableAFNORAddressPatch) Get() *AFNORAddressPatch {
	return v.value
}

func (v *NullableAFNORAddressPatch) Set(val *AFNORAddressPatch) {
	v.value = val
	v.isSet = true
}

func (v NullableAFNORAddressPatch) IsSet() bool {
	return v.isSet
}

func (v *NullableAFNORAddressPatch) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAFNORAddressPatch(val *AFNORAddressPatch) *NullableAFNORAddressPatch {
	return &NullableAFNORAddressPatch{value: val, isSet: true}
}

func (v NullableAFNORAddressPatch) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAFNORAddressPatch) UnmarshalJSON(src []byte) error {
	v.isSet = true
