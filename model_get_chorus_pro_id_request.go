...
// checks if the GetChorusProIdRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetChorusProIdRequest{}
...
func NewGetChorusProIdRequest(siret string) *GetChorusProIdRequest {
	this := GetChorusProIdRequest{}
	this.Siret = siret
	var identifierType string = "SIRET"
...
func (o *GetChorusProIdRequest) SetCredentialsNil() {
...
func (o GetChorusProIdRequest) MarshalJSON() ([]byte, error) {
...
func (o GetChorusProIdRequest) ToMap() (map[string]interface{}, error) {
...
func (o *GetChorusProIdRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varGetChorusProIdRequest := _GetChorusProIdRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGetChorusProIdRequest)

	if err != nil {
		return err
	}

	*o = GetChorusProIdRequest(varGetChorusProIdRequest)

	return err
}

type NullableGetChorusProIdRequest struct {
	value *GetChorusProIdRequest
	isSet bool
}

func (v NullableGetChorusProIdRequest) Get() *GetChorusProIdRequest {
	return v.value
}

func (v *NullableGetChorusProIdRequest) Set(val *GetChorusProIdRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableGetChorusProIdRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableGetChorusProIdRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetChorusProIdRequest(val *GetChorusProIdRequest) *NullableGetChorusProIdRequest {
	return &NullableGetChorusProIdRequest{value: val, isSet: true}
}

func (v NullableGetChorusProIdRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetChorusProIdRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
