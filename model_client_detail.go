...
// ClientDetail Detailed client view (same fields for now).
...
type _ClientDetail ClientDetail
...
func (o *ClientDetail) SetSiretNil() {
	o.Siret.Set(nil)
}
...
func (o *ClientDetail) SetDescriptionNil() {
...
func (o *ClientDetail) SetPdpIsActiveNil() {
...
func (o *ClientDetail) SetPdpIsMockNil() {
	o.PdpIsMock.Set(nil)
}
...
func (o *ClientDetail) UnmarshalJSON(data []byte) (err error) {
	...
	varClientDetail := _ClientDetail{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varClientDetail)

	if err != nil {
		return err
	}

	*o = ClientDetail(varClientDetail)
