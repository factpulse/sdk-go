...
type AFNORReasonCodeEnum string
...
var AllowedAFNORReasonCodeEnumEnumValues = []AFNORReasonCodeEnum{
	"EmptyAttachement",
	"AttachmentTypeError",
	"EmptyFlow",
	"OtherTechnicalError",
...
func (v *AFNORReasonCodeEnum) UnmarshalJSON(src []byte) error {
	var value string
	err := json.Unmarshal(src, &value)
	if err != nil {
		return err
	}
	enumTypeValue := AFNORReasonCodeEnum(value)
	for _, existing := range AllowedAFNORReasonCodeEnumEnumValues {
	...
	return fmt.Errorf("%+v is not a valid AFNORReasonCodeEnum", value)
}

// NewAFNORReasonCodeEnumFromValue returns a pointer to a valid AFNORReasonCodeEnum
// for the value passed as argument, or an error if the value passed is not allowed by the enum
func NewAFNORReasonCodeEnumFromValue(v string) (*AFNORReasonCodeEnum, error) {
	ev := AFNORReasonCodeEnum(v)
	if ev.IsValid() {
		return &ev, nil
	} else {
		return nil, fmt.Errorf("invalid value '%v' for AFNORReasonCodeEnum: valid values are %v", v, AllowedAFNORReasonCodeEnumEnumValues)
	}
}

// IsValid return true if the value is valid for the enum, false otherwise
func (v AFNORReasonCodeEnum) IsValid() bool {
	for _, existing := range AllowedAFNORReasonCodeEnumEnumValues {
		if existing == v {
			return true
		}
...
// Ptr returns reference to AFNOR_ReasonCodeEnum value
func (v AFNORReasonCodeEnum) Ptr() *AFNORReasonCodeEnum {
	return &v
}

type NullableAFNORReasonCodeEnum struct {
	value *AFNORReasonCodeEnum
	isSet bool
}

func (v NullableAFNORReasonCodeEnum) Get() *AFNORReasonCodeEnum {
	return v.value
}

func (v *NullableAFNORReasonCodeEnum) Set(val *AFNORReasonCodeEnum) {
	v.value = val
	v.isSet = true
}

func (v NullableAFNORReasonCodeEnum) IsSet() bool {
	return v.isSet
}

func (v *NullableAFNORReasonCodeEnum) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAFNORReasonCodeEnum(val *AFNORReasonCodeEnum) *NullableAFNORReasonCodeEnum {
	return &NullableAFNORReasonCodeEnum{value: val, isSet: true}
}

func (v NullableAFNORReasonCodeEnum) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAFNORReasonCodeEnum) UnmarshalJSON(src []byte) error {
	v.isSet = true
